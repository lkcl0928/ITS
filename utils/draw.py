...
def pil_draw_box(im,bbox,identities=None,font=""):
    # 1.读取图片
    ...
    for i,bbox1 in enumerate(bbox):
        ...
        draw.rectangle([tuple(text_origin1), tuple(text_origin1 + label_size1)], fill='#006400')
...
def pil_draw_box3(im, bbox, identities=None, carSpeed={}, carLicence={}, carDirection={}, font=""):
    # 1.读取图片
    # im = Image.open(img_path)
